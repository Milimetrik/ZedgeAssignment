 ...
 */
public abstract class Hilt_FavouriteImagesFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_FavouriteImagesFragment() {
    super();
  }

  Hilt_FavouriteImagesFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((FavouriteImagesFragment_GeneratedInjector) this.generatedComponent()).injectFavouriteImagesFragment(UnsafeCasts.<FavouriteImagesFragment>unsafeCast(this));
    }
  }
