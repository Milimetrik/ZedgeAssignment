 ...
 */
public abstract class Hilt_ImageListFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_ImageListFragment() {
    super();
  }

  Hilt_ImageListFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((ImageListFragment_GeneratedInjector) this.generatedComponent()).injectImageListFragment(UnsafeCasts.<ImageListFragment>unsafeCast(this));
    }
  }
